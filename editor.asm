...
; XXX this is a hack to help bootstrap the "color determines action" way is
; much better, and allows more flexibility
action:
	dq interpret
...
; TODO make a functioning "(color) console" with the vectored key
; technique, such that it provides equivalent functionality to what you
; have now, plus extensibility to color.

; RANDOM something like : mainloop c@+ act mainloop ;
